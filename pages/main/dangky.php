...
<div style="border: 2px solid black; border-radius: 10px;height: 540px; width: 50%; margin-left: 25%; margin-top: 70px;">
<h1 style="	padding-top: 10px; text-align: center;">Đăng ký</h1>
<form action="" method="POST">
<table class="dangky"  width="100%" style="border-collapse: collapse;">
	<tr>
		<td>Họ và tên</td>

...
<div style="height: auto;">     
  ...
  ?></h3>
    ...
    ?>
        ...
        <tr>
            <td colspan="8">
                <h3 style="float: left;"> Tổng tiền : <?php echo number_format($tongtien,0,',','.') . ' VNĐ'  ?></h3>
                ...
                <div style="clear:both;"> </div>
                    ...
                    ?>
                            <h3 style="text-align:center;"><a href="pages/main/thanhtoan/index.php?quanly=vanchuyen">Đặt hàng</a></h3>
                    <?php
                    }else{
                    
                    ?>
                         <p style="text-align:center"><a href="index.php?quanly=dangnhap">Đăng nhập đặt hàng</a></p>
                    <?php
                     }
